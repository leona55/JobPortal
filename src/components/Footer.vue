<template>
  <footer>
    <div class="container">
      <div class="left">
        <div class="col-1">
          <router-link class="header" :to="{ name: 'Home' }">Smoothie</router-link>
          <ul>
            <li>
        ...
        <div class="col-2">
          <ul>
            ...
            <router-link class="link" :to="{ name: 'Smoothie' }">Smoothie</router-link>
      ...
      <div class="right">
        <p>Copyright 2022 All Rights Reseerrved</p>
      </div>
    </div>
  </footer>
</template>
